    ...
    public class LT1DApproach : AbstractLearningTask<ManInWorld>
    {
        ...
        protected void CreateTarget()
        {
            ...
            int maxTargetDistance
                = TSHints[TSHintAttributes.DEPRECATED_MAX_TARGET_DISTANCE] < 0 ? WrappedWorld.FOW_WIDTH : (int)(WrappedWorld.FOW_WIDTH * TSHints[TSHintAttributes.DEPRECATED_MAX_TARGET_DISTANCE]);

...
%~2..\..\..\packages\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user -target:"%~2..\..\..\packages\xunit.runner.console.2.1.0\tools\xunit.console.exe" -targetargs:"%~2%~3%~4 -noshadow -notrait \"coverageSkip=true\"" -filter:"-[xunit*] -[TypeMap] -[*Tests] -[Utils] +[]" -output:%~2coverage.xml

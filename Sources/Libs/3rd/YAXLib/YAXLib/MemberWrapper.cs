...
namespace YAXLib
{
    ...
    internal class MemberWrapper
    {
        ...
        /// <param name="dontSerializePropertiesWithNoSetter"></param>
        /// <returns>
        ...
        private void ProcessYaxAttribute(object attr)
        {
            ...
            else if (attr is YAXSerializableFieldAttribute) 
            {
                ...
                YAXSerializableFieldAttribute sattr =  (attr as YAXSerializableFieldAttribute);
                if (sattr.DefaultValue != null) DefaultValue = sattr.DefaultValue;
            }

            ...
            else //if the collection was serialized recursively
            {
                ...
                foreach (XElement childElem in elemsToSearch)
                {
                    ...
                    if (realTypeAttribute != null)
                    {
                        ...
                        {
                            OnExceptionOccurred(new YAXException("Type not found: " + realTypeAttribute.Value), m_defaultExceptionType);
                        }
                    }
                    ...
                    else
                    {
                        ...
                        {
                            OnExceptionOccurred(new YAXException(e.Message), m_defaultExceptionType);
                        }
                    }
                }
            } // end of else if 

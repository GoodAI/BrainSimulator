...
"C:\Program Files (x86)\Windows Kits\8.1\bin\x64\signtool.exe" sign /fd SHA256 /a /f %CERT_FILE% /p %PASSWORD% /d %DESCRIPTION% %INSTALLER_FILE%

copy %INSTALLER_FILE% "%INSTALLER_NAME_BASE%%~1.msi"
